...
(function (root, factory) {
  ...
  */
  ...
  function _showElement(targetElement) {
    ...
    if (oldHelperLayer != null) {
      ...
      self._lastShowElementTimer = setTimeout(function() {
        ...
        if (oldHelperNumberLayer != null) {
          oldHelperNumberLayer.textContent = targetElement.step;
        }
        //set current tooltip text
        oldtooltipLayer.textContent = targetElement.intro;
      ...
      tooltipTextLayer.textContent = targetElement.intro;
      ...
      if (this._options.showStepNumbers == true) {
        ...
        helperNumberLayer.textContent = targetElement.step;
      ...
      nextTooltipButton.textContent = this._options.nextLabel;
      ...
      prevTooltipButton.textContent = this._options.prevLabel;

      //skip button
      var skipTooltipButton = document.createElement('a');
      skipTooltipButton.className = 'introjs-button introjs-skipbutton';
      _setAnchorAsButton(skipTooltipButton);
      skipTooltipButton.textContent = this._options.skipLabel;
    ...
    if (this._currentStep == 0 && this._introItems.length > 1) {
      ...
      // last step of tour
      if (typeof skipTooltipButton !== "undefined" && skipTooltipButton != null) {
        skipTooltipButton.textContent = this._options.doneLabel;
  ...
  function _showHintDialog(stepId) {
    ...
    tooltipWrapper.textContent = item.hint;

    var closeButton = document.createElement('a');
    closeButton.className = 'introjs-button';
    closeButton.textContent = this._options.hintButtonLabel;
